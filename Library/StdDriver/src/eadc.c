 ...
 * @file     eadc.c
 * @version  V2.00
 * @brief    M471 series EADC driver source file
 *
...
/**
  ...
  * @param[in] u32Channel Specifies the sample module channel, valid value are from 0 to 23.
  * @return None
  ...
  *         sample module 24~26 is fixed for ADC channel 24, 25, 26 input sources as band-gap voltage, temperature sensor, and DAC output.
  */
...
/**
  ...
  * @return None
  * @details User can configure the trigger delay time by setting TRGDLYCNT (EADC_SCTLn[15:8], n=0~23) and TRGDLYDIV (EADC_SCTLn[7:6], n=0~23).
