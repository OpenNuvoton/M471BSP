 ...
 * @file     timer.c
 * @version  V1.00
 * @brief    M471 Timer Controller(Timer) driver source file
 *
...
/**
  ...
  * @param[in] u32DropCount This parameter has no effect in M471 series BSP
  * @param[in] u32Timeout This parameter has no effect in M471 series BSP
