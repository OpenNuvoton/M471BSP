 ...
 * $Revision: 3 $
 * $Date: 20/08/12 5:09p $
 * @brief    Show how to control SMBus interface and use SMBus protocol between Host and Slave.
 * @note
...
int32_t main(void)
{
    ...
    while (ch != 0x30)
    {
        ...
        */
        ...
        printf("\n");
        printf("I2C0_SDA(PC.0), I2C0_SCL(PC.1), I2C_ALERT(PC.3), I2C_SUSPEND(PC.2)\n");
        printf("I2C1_SDA(PB.0), I2C1_SCL(PB.1), I2C_ALERT(PB.9), I2C_SUSPEND(PB.8)\n\n");
