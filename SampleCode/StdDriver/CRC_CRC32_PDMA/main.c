 ...
 * @return      None
 *
 * @details     The DMA default IRQ, declared in startup_M471.s.
 */
...
int main(void)
{
    ...
    /*  Case a. */
    u32FMCChecksum = GetFMCChecksum(0x0, size);   /* Keep write-protection disabled to operate FMC ISP function */
